...
<script>
import CarouselComponentCard from "@/components/common/CarouselComponentCard.vue";
...
<style scoped>
@import url("https://fonts.googleapis.com/css2?family=Black+Han+Sans&family=Poor+Story&family=Sunflower&display=swap");
body {
  background: #f8f8f8;
  color: #2c3e50;
