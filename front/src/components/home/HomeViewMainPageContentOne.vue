<template>
  <div class="chatbox" id="app">
    <div
      class="colorPanel"
      :style="{
        display: colorPanelShown ? 'flex' : 'none',
        opacity: colorPanelShown ? 'flex' : 'none',
      }"
    >
      <div
        class="colorPanel__colorSlot"
        v-for="(color, idx) in colors"
        :key="idx"
      >
        <div
          class="colorPanel__color"
    ...
    <div class="chatbox__header">
      ...
      <div
        ...
        v-on:click="colorPanelShown = !colorPanelShown"
      ></div>
    </div>
    <div class="chatbox__messages">
      <div
        class="chatbox__messageBox"
      ...
      >
        <div
          ...
          :class="{ 'chatbox__message--primary': message.primary }"
          :style="{ background: message.primary ? chatColor : 'inital' }"
        >
          {{ message.text }}
    ...
    <div class="chatbox__inputPanel">
      ...
      />
      <div
        class="chatbox__tooltip chatbox__tooltip--bottom"
        :style="{
          opacity: newMessage.length > 2 && !this.tutorialSeen ? 0.7 : 0,
        }"
      >
